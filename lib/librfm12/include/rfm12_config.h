...
/*
	...
	SDO             | MISO
	nIRQ            | PCINT9
	FSK/DATA/nFFS   | VCC (done with breakout board)
	DCLK/CFIL/FFIT  |  -
	CLK             |  -
	nRES            |  -
	GND             | GND
...
//TRX format characteristics
#define RFM12_TRX_FRAME_SIZE 30
...
//TODO: Change to PCINT9 // Although because of how INT_ON() and INT_OFF work that would become wrong
...
#define RFM12_INT_SETUP() PCICR |= _BV(PCIE1);
